# Public competition-author Mega Lucario ex sample baseline, v2 local tweak.
...
# v2 tweak: bias setup/search/energy toward Riolu -> Mega Lucario to reduce Abomasnow losses.
