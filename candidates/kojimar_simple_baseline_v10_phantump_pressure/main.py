...
class LucarioPolicy:
    ...
    def _target_score(self, pokemon: Pokemon) -> int:
        ...
        if self._opponent_is_phantump_control():
            # Public episodes show this control shell is difficult for the
            # Fighting deck because the main Ghost line resists Fighting. In
            # that matchup, prioritize KO-able support and low-HP basics over
            # speculative pressure on Trevenant.
            if pokemon.id == C.DUNSPARCE:
                ...
                score += 150
            elif pokemon.id == C.HOPS_CRAMORANT:
                score -= 150
        return score
