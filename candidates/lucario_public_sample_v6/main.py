# Public competition-author Mega Lucario ex sample baseline, v6 local tweak.
...
# v6 tweak: keep v3 deck-safety brake and add TO_HAND-only Lucario-line search pressure.
