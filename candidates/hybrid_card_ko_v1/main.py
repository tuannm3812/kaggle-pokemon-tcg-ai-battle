"""Hybrid card-selection plus tactical-KO candidate for Pokemon TCG AI Battle.

This candidate intentionally keeps the promoted agent's development-first main
phase order. It adds only:

1. a high-confidence immediate-knockout attack override;
2. planner-style scoring for non-main CARD selections.

The goal is to capture useful setup/search/switch/discard behavior without
importing planner v2's broader main-phase action reordering.
"""
