# Public competition-author Mega Lucario ex sample baseline, v4 local hybrid tweak.
...
# v4 tweak: combine v2 Lucario-line pressure with v3 late-game deck-safety brake.
        ...
        if o.type == OptionType.NUMBER:
            ...
            if card != None:
                ...
                if context == SelectContext.SWITCH or context == SelectContext.TO_ACTIVE:
                    ...
                    # v2: prioritize the Mega Lucario line over secondary attackers.
                    if card.id == Riolu:
                        score = 5
                    elif card.id == Solrock:
                        score = 3
                    ...
                    if card.id == Makuhita:
                        if field_counts[Riolu] + field_counts[Mega_Lucario_ex] == 0:
                            score -= 20
                        ...
                        if field_counts[Makuhita] >= 1 and field_counts[Mega_Lucario_ex] >= 1:
                            score += 5
                        else:
                            score -= 35
                    elif card.id == Lunatone:
            ...
            if data.cardType == CardType.POKEMON:
                ...
                if card.id == Lunatone or card.id == Solrock:
                    if field_counts[card.id] >= 1:
                        score = -1
                    elif field_counts[Riolu] + field_counts[Mega_Lucario_ex] == 0:
                        score -= 5000
                elif card.id == Riolu:
                    score += 5000
                    if field_counts[card.id] + field_counts[Mega_Lucario_ex] >= 2:
