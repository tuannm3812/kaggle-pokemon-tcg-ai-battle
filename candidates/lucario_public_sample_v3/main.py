# Public competition-author Mega Lucario ex sample baseline, v3 local tweak.
...
# v3 tweak: late-game deck-safety brake for draw/search cards in long Abomasnow games.
