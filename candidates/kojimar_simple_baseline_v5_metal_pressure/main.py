...
def target_score(pokemon: Pokemon) -> int:
    ...
    # Leaderboard replay telemetry showed repeated losses into Metal/Cinderace
    # decks. These boosts are intentionally target-only: they should improve
    # Boss/attack planning against that family without changing setup tempo.
